...
def launch_setup(context, *args, **kwargs):
    ...
    return [
        Node(
            ...
            executable='run_with_rosbag',
            name='localization_rosbag_node',
            output='screen',
            parameters=[{
                'bag_path': bag_path,
                'map_file': map_file,
                ...
                'cloud_odom_topic': cloud_odom_topic,
            }],
            remappings=[
...
def generate_launch_description():
    ...
    return LaunchDescription([
        DeclareLaunchArgument('bag_path', default_value='', description='Path to the rosbag dir'),
